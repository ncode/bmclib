...
var (
	...
	answers = map[string]map[string][]byte{
		...
		"IDrac8":        map[string][]byte{"/session": []byte(`{"aimGetProp" : {"hostname" :"incubatordb-2011","gui_str_title_bar" :"","OEMHostName" :"bkbuild-204.lhr4.prod.booking.com","fwVersion" :"2.50.33","sysDesc" :"PowerEdge M630","status" : "OK"}}`)},
